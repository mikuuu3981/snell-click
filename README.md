...
主面板只显示每个核心的一行摘要，入口固定为“Snell 管理”“Xray 管理”和“面板设置 / 升级”。Snell 未安装时会在安装流程中选择 v5 稳定版或 v6 Beta；只存在一个 Snell 版本时会直接进入该实例，只有兼容已有双实例安装时才显示 v5/v6 选择页。
...
- 按核心收敛的 Snell、Xray 和面板设置顶层导航
- 在 Snell 安装时选择 v5 稳定版或 v6 Beta
- 独立安装、重装、更新 Snell 内核和卸载 v5/v6
